    ...
    (function(TLE) {
        ...
        TLE.yaaw_pop = function() {
            ...
            var content = '<div >'+ fileList
                ...
                +'<li><input type="text" id="TLE_aria2_jsonrpc_dir" style="width: 350px"  value="'
                +TLE.getConfig("TLE_aria2_jsonrpc_dir")
                +'"/></li>'
                +'</ul>'
        ...
        function init() {
            ...
            $("#setting_main_tpl").text($("#setting_main_tpl").text().replace(/(<\/div>\s+<div class="btnin">)/,
                ...
                +'<li><b>Aria2 JSON-RPC Dir</b></li>'
                +'<li>Path: <input type="text" id="TLE_aria2_jsonrpc_dir_default" style="width: 350px" value="'+TLE.getConfig("TLE_aria2_jsonrpc_dir")+'"/></li>'
            ...
            set_notice_submit = function(f) {
                ...
                var jsonrpc_dir = $("#TLE_aria2_jsonrpc_dir_default").val();

                if (TLE.getConfig("TLE_exporter") != config_str || TLE.getConfig("TLE_aria2_jsonrpc") != jsonrpc_path || TLE.getConfig("TLE_aria2_jsonrpc_webui") != jsonrpc_webui || TLE.getConfig("TLE_aria2_jsonrpc_dir") != jsonrpc_dir) {
                    TLE.setConfig("TLE_exporter", config_str);
                    TLE.setConfig("TLE_aria2_jsonrpc", jsonrpc_path);
                    TLE.setConfig("TLE_aria2_jsonrpc_dir", jsonrpc_dir);
